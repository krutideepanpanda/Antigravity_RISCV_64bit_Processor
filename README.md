...
* [Project Roadmap, Status Matrix & Changelog](file:///home/bazzite/Openlane_processor/docs/project_roadmap_and_changelog.md): Master engineering tracking log detailing live module verification/synthesis status, complete historical version changelog, future ISA expansion roadmap (M/A/C extensions, L1 cache hierarchy, MMU), and continuous git synchronization methodology.
...
* [User Guide & Quickstart](file:///home/bazzite/Openlane_processor/docs/user_guide.md): Comprehensive step-by-step instructions for running `make lint`, `make sim-all`, `make openlane`, inspecting GTKWave VCD dumps, utilizing our automated synchronization script ([scripts/git_sync.sh](file:///home/bazzite/Openlane_processor/scripts/git_sync.sh)), and utilizing our custom domain agent skills (`.skills/`).
