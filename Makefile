...
lint:
	...
	@if command -v verilator >/dev/null 2>&1; then \
		verilator --lint-only -Wall --top-module asic_top -Wno-MULTITOP -Wno-DECLFILENAME -Wno-UNOPTFLAT -Wno-UNUSEDSIGNAL -Wno-UNUSEDPARAM -Wno-UNDRIVEN -I$(INC_DIR) $(RTL_CORE_FILES) $(RTL_TOP_FILES) && echo "✅ Verilator lint check PASSED!"; \
	fi
